/**********************************************************
 * Pocker.c modified from chapter 10.5                    *
 *         All functions pass by argument                 * 
 * ********************************************************/
...
void read_cards(int num_in_ranks[NUM_RANKS], int num_in_suit[NUM_SUITS]);
void analyze_hand(int num_in_ranks[NUM_RANKS], int num_in_suit[NUM_SUITS],
...
int main(void) {
    ...
    while (true) {
        read_cards(num_in_ranks, num_in_suit);
        analyze_hand(num_in_ranks, num_in_suit, &straight, &flush, &four, &three, &royal, &ace_low, &pairs);
